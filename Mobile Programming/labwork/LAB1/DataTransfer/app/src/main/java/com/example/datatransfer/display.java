...
public class display extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView name = v.findViewById(R.id.res_name);
        TextView age = v.findViewById(R.id.res_age);
        TextView add = v.findViewById(R.id.res_add);
        name.setText("Name : "+getArguments().getString("name"));
        age.setText("Age : "+getArguments().getString("age"));
        add.setText("Address : "+getArguments().getString("add"));
